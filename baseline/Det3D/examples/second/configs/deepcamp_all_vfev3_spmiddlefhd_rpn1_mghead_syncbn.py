...
data_root = "/home/jty/data/kitti/deecamp"
...
db_sampler = dict(
    type="GT-AUG",
    enable=True,
    db_info_path="/home/jty/data/kitti/deecamp/dee_dbinfos_train.pkl",
    sample_groups=[dict(Car=30), dict(Truck=40), dict(Tricar=35),dict(Cyclist=35),dict(Pedestrian=35)],
    db_prep_steps=[
...
train_anno = "/home/jty/data/kitti/deecamp/dee_infos_train.pkl"
val_anno = "/home/jty/data/kitti/deecamp/dee_infos_val.pkl"
test_anno = None
...
lr_config = dict(
    type="one_cycle", lr_max=0.003/8 * 6, moms=[0.95, 0.85], div_factor=10.0, pct_start=0.4,
)
